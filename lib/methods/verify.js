 ...
 *
 * @throws {AdMobVerifierKeysUnavailable|AdMobVerifierInvalidKeyId|AdMobVerifierNoSignature|AdMobVerifierNoKeyId|AdMobVerificationFailed}
...
async function verify (url, throwable = false) {
  ...
  const verificationData = queryString.substring(1, queryString.indexOf('signature') - 1);
